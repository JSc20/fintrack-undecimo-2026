...
namespace FinTrack_II_Trimestre.Controllers
{
    public class UserController : Controller
    {
        ...
        public IActionResult Register(User user)
        {
            ...
            // Crear automáticamente el Profile del usuario usando los datos del formulario
            string fullName = Request.Form["FullName"].ToString();
            string email = Request.Form["Email"].ToString();
            string phone = Request.Form["Phone"].ToString();
            int age = 0;
            int.TryParse(Request.Form["Age"].ToString(), out age);
            ...
            {
                // Si la validación del Profile falla a nivel de base de datos, lo ignoramos para no romper el registro,
                // el usuario podrá editarlo luego. Idealmente, se validaría antes.
            }

            TempData["SuccessMessage"] = "Cuenta y perfil creados exitosamente. Inicia sesión.";
