...
namespace FinTrack_II_Trimestre.Controllers
{
	public class SavingsGoalController : BaseController
	{
        ...
        public IActionResult Create(SavingsGoal goal)
        {
            ...
            // 1. Limpiamos el estado de estas propiedades por si MVC las invalidó en el binding inicial
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    // 2. Extraemos el mensaje real de la base de datos para saber qué falló
                    string errorMessage = ex.InnerException != null ? ex.InnerException.Message : ex.Message;
                    ModelState.AddModelError("", $"Error de Base de Datos: {errorMessage}");
                }
            }
